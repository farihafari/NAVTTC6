        ...
        <div class="flex-w flex-tr">
            <div class="size-215 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
                <form method="post">
                    ...
                    <div class="bor8 m-b-20 how-pos4-parent">
                        <input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="phone" value="<?php echo $_SESSION['sessionPhone'] ?>" placeholder="Your Password">
                        <img class="how-pos4 pointer-none" src="images/icons/icon-email.png" alt="ICON">
                    </div>
                    <div class="bor8 m-b-20 how-pos4-parent">
                        <textarea name="" id="" class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" rows="3" name="address"></textarea>
                        <img class="how-pos4 pointer-none" src="images/icons/icon-email.png" alt="ICON">
                    </div>
